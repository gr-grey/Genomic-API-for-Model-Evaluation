...
| ----------- | ----------- | ----------- |
| Gosai MPRA      |[https://zenodo.org/records/14920112](https://zenodo.org/records/14920112)      |  Gosai et al. (2024), https://doi.org/10.1038/s41586-024-08070-z : 776,474 sequences (200bp), measured in K562 (erythroid precursors), HepG2 (hepatocytes) and SK-N-SH (neuroblastoma) |


| Predictor     | Zenodo Download link | Description|
| ----------- | ----------- | ----------- |
| DREAMRNN      |[https://zenodo.org/records/14649126](https://zenodo.org/records/14920340)       |  Rafi et al. (2024), https://doi.org/10.1038/s41587-024-02414-w : DREAMRNN Architecture trained on human K562 cells     |
